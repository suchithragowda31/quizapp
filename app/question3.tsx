...
export default function Question3() {
  ...
  const [checked, setChecked] = useState('Spicy'); 
  ...
  return (
    ...
    >
      <View style={styles.container}>
        ...
        <Text style={styles.questionText}>Question 3: How spicy do you like your food</Text>

        <View style={styles.optionsContainer}>
          {['Mild', 'Medium', 'Spicy', 'Very Spicy'].map((option) => (
